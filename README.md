...
```js
// var favoriteMovies = ['shuter Island' , 'pairt of caribbean' , 'God Father' , 'monsters inc' , 'Deadpool'];
```
...
```
//// I tried to use push but it doesn't work . so I looked for another way.
